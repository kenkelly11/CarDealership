...
{
    [TestFixture]
    public class CarsRepositoryADOTests
    {
        [SetUp]
        public void Init()
        {
        ...
        public void CanLoadCars()
        {
            ...
            var cars = repo.GetAllCars().ToList();
            ...
            Assert.AreEqual("/Images/2018AcuraTLX.jpg", cars[1].IMGFilePath);
        ...
        public void CanGetCarById()
        {
            ...
            Assert.AreEqual("/Images/2018AcuraTLX.jpg", car.IMGFilePath);
        ...
        public void CanGetFeaturedCars()
        {
            ...
            Assert.AreEqual("/Images/2018AcuraTLX.jpg", featuredCars[0].ImageURL);
        ...
        public void CanGetSoldCars()
        {
            ...
            Assert.IsTrue(cars[1].IsFeatured);
            Assert.AreEqual(1, cars[1].UnitsInStock);
            Assert.AreEqual("15000", cars[1].Mileage);
            Assert.AreEqual(5, cars[1].BodyColorId);
            ...
            Assert.AreEqual("/Images/2017FordEscape.jpg", cars[1].IMGFilePath);
        ...
        public void CanUpdateCar()
        {
            Car car = new Car
            {
                ...
                MSRP = 21000m,
                IMGFilePath = "Images/placeholder.png",
                VehicleDetails = "2010 Ford Escape. Fully Loaded!"
            };
            ...
            car.Mileage = "3";
            car.ModelYear = new DateTime(2023, 1, 1);
            car.MakeId = 2;
            car.ModelId = 3;
            ...
            Assert.AreEqual(updatedCar.ModelYear, new DateTime(2023, 1, 1));
        ...
        public void CanSearchForNewCarOnMinYear()
        {
            ...
            Assert.AreEqual("/Images/2017ToyotaTundra.jpg", searchCarResults[1].IMGURL);
        ...
        public void CanSearchForNewCarOnMaxPrice()
        {
            ...
            Assert.AreEqual(new DateTime(2021, 1, 1).Year.ToString(), searchCarResults[0].Year);
            ...
            Assert.AreEqual("/Images/2017ToyotaTundra.jpg", searchCarResults[0].IMGURL);
        ...
        public void CanSearchForUsedCarOnMinYear()
        {
            ...
            Assert.AreEqual("Automatic", searchCarResults[1].Transmission);
            Assert.AreEqual("/Images/2017FordEscape.jpg", searchCarResults[1].IMGURL);
            Assert.AreEqual("3ABC3ABC3ABC3ABC3", searchCarResults[1].VIN);
            Assert.AreEqual("15000", searchCarResults[1].Mileage);
        ...
        public void CanSearchForUsedCarSearchTerm()
        {
            ...
            Assert.AreEqual("Automatic", searchCarResults[0].Transmission);
            Assert.AreEqual("/Images/2017FordEscape.jpg", searchCarResults[0].IMGURL);
            Assert.AreEqual("3ABC3ABC3ABC3ABC3", searchCarResults[0].VIN);
            Assert.AreEqual("15000", searchCarResults[0].Mileage);
            ...
            Assert.AreEqual("White", searchCarResults[1].InteriorColor);
            Assert.AreEqual("Automatic", searchCarResults[1].Transmission);
            Assert.AreEqual("/Images/MockUsedCar.jpg", searchCarResults[1].IMGURL);
            Assert.AreEqual("6ABC6ABC6ABC6ABC6", searchCarResults[1].VIN);
            Assert.AreEqual("200000", searchCarResults[1].Mileage);
