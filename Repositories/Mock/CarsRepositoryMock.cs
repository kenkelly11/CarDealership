...
namespace CarDealership.Data.Repositories.Mock
{
    public class CarsRepositoryMock : ICarsRepository
    {
        ...
        private static Car _carOne = new Car
        {
            ...
            SalePrice = 50315.00m,
            MSRP = 51815.00m,
            IMGFilePath = "/Images/2017ToyotaTundra.jpg",
        ...
        private static Car _carTwo = new Car
        {
            ...
            SalePrice = 33000.00m,
            MSRP = 34150.00m,
            IMGFilePath = "/Images/2018AcuraTLX.jpg",
        ...
        private static Car _carThree = new Car
        {
            ...
            SalePrice = 22669.00m,
            MSRP = 24500.00m,
            IMGFilePath = "/Images/2017FordEscape.jpg",
            ...
            if (_cars.Count() == 0)
            {
                ...
                for (int i = 1; i < 4; i++)
                {
                    Car car = new Car
                    {
                        ...
                        InteriorColorId = 1 + i,
                        TransmissionId = 1,
                        IMGFilePath = "/Images/MockNewCar.jpeg",
                        IsFeatured = true,
                        IsNew = true,
                        BodyStyleId = i,
                        IsSold = false,
        ...
        public void Update(Car Car)
        {
            ...
            _cars.Insert(index, Car); // new car is added to database
        }
